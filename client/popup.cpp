...
void PopUp::show()
{
    ...
    setGeometry((QApplication::desktop()->availableGeometry().width()-width() + QApplication::desktop() -> availableGeometry().x())/2,
                (QApplication::desktop()->availableGeometry().height() - 36 - height() + QApplication::desktop() -> availableGeometry().y())/2,
                width(),
                height());
    QWidget::show();
